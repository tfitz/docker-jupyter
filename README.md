![docker pulls](https://img.shields.io/docker/pulls/tfitz/jupyter-notebook.svg) ![docker stars](https://img.shields.io/docker/stars/tfitz/jupyter-notebook.svg)

# Jupyter Notebook: (opinionated) Julia Stack
...
Custom additions
* Julia v0.5.x with PyPlot, HDF5, SymPy, ODE, & ControlSystems
...
```
docker run -d -p 8888:8888 tfitz/jupyter-notebook
```
...
```
docker run -d -p 8888:8888 tfitz/jupyter-notebook start-notebook.sh --NotebookApp.password='sha1:74ba40f8a388:c913541b7ee99d15d5ed31d4226bf7838f83a50e'
```
...
```
docker run -it --rm tfitz/jupyter-notebook start.sh ipython
```
